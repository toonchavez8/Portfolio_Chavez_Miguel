...
const Lastupdatedbadge = () => {
    ...
    return (
        <Link
            ...
            className="ease  right-0 mr-3 mt-3 flex items-center justify-center gap-1 rounded-full border border-neutral px-4 font-mono text-xs opacity-50 transition-all hover:scale-105 hover:bg-neutral hover:text-base-100 hover:opacity-100 dark:border-base-300 xs:absolute sm:absolute">
            <FiGitCommit />
