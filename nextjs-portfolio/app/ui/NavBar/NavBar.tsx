...
export const NavBar = () => {
    ...
    return (
        <header className=" container sticky inset-x-0 top-0 z-30 mx-auto flex w-11/12 items-center justify-between border-b border-primary/50 bg-opacity-25  px-4 filter backdrop-blur-sm dark:border-primary/15  dark:bg-neutral-900  dark:bg-opacity-10 md:w-10/12 lg:w-7/12 ">
