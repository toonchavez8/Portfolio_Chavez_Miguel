...
export const Footer = () => {
    return (
        <footer className="mx-auto flex w-full max-w-[67.5rem] flex-col items-center justify-center border-t border-asphalt-500/50 py-4 text-2xl font-bold dark:border-asphalt-500/15">
